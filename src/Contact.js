        ...
        <section className="contact-section bg-black" id='contact'>
            <div className="container px-4 px-lg-5">
                    ...
                    <div className="col-md-4 mb-3 mb-md-0">
                        <div className="card py-4 h-100">
                            <div className="card-body text-center">
                                ...
                                <div className="small text-black-50">Bhavnagar</div>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-4 mb-3 mb-md-0">
                        <div className="card py-4 h-100">
                            <div className="card-body text-center">
                                ...
                                <hr className="my-4 mx-auto" />
                                <div className="small text-black-50"><a href="#!">mangesh.socialmedia@gmail.com</a></div>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-4 mb-3 mb-md-0">
                ...
                <div className="social d-flex justify-content-center">
                    ...
                    <a className="mx-2" href="#!"><i className="fab fa-unsplash"></i></a>
